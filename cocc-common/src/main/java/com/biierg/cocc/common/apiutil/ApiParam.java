...
public class ApiParam implements Serializable {
    ...
    public static class Header implements Serializable {
        ...
        private String mobileStandard; // 手机网络版本 (GSM ; G ; CDMA ; GSM TD-SCDMA….)
        ...
        /**
         * @param acceptApiVersion the acceptApiVersion to set
         */
        ...
        /**
         * @param mobileStandard the mobileStandard to set
         */
        ...
        /**
         * @param appVersionNo the appVersionNo to set
         */
