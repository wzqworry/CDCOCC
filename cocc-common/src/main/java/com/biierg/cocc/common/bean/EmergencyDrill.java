...
public class EmergencyDrill implements Serializable {
    ...
    private List<EmergencyPlaceDrill> emergencyPlaceList;
    ...
    public List<EmergencyPlaceDrill> getEmergencyPlaceList() {
        return emergencyPlaceList;
    }

    public void setEmergencyPlaceList(List<EmergencyPlaceDrill> emergencyPlaceList) {
