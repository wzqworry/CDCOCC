 ...
 *
 */
public class BaseRoutelibVo implements Serializable {
	...
	// 所有车站信息
	private List<BaseRoutelibViaStationsVo> viastations = new ArrayList<>();
	...
	public List<BaseRoutelibViaStationsVo> getViastations() {
		return viastations;
	}

	public void setViastations(List<BaseRoutelibViaStationsVo> viastations) {
