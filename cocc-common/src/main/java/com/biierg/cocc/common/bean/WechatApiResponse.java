 ...
 * @author lei
 */
public class WechatApiResponse implements Serializable {
	private static final long serialVersionUID = 1L;
	private Logger logger = LoggerFactory.getLogger(WechatApiResponse.class);
	...
	public WechatApiResponse(CloseableHttpResponse response) {
