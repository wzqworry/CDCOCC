 ...
 */
public interface IOpenSmsService {
     ...
     */
    public ApiResult sendSms(String[] mobiles, String smsContent, int smsPriority, String msgGroup, boolean isMo) throws Exception;
}
