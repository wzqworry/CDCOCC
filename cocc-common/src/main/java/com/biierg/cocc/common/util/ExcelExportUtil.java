...
public class ExcelExportUtil {
     ...
     */
    public void writeToFile(HttpServletResponse response, String filePath, String[] sheetName, List<? extends Object[]> title, List<? extends List<? extends Object[]>> data) throws FileNotFoundException, IOException {
...
//        new ExcelExportUtil().writeToFile(null, "D:\\xx.xlsx", sheetName, titles, data_);
//    }
}