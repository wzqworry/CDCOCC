/**
 * 版权所有@北京京投亿雅捷交通科技有限公司。未经许可，不得擅自复制、传播
 */
...
public class LatitudeUtil {
	...
	public static double distance(double lon1, double lat1, double lon2, double lat2) {
		...
		double c = 2.0D * Math.asin(Math.sqrt(Math.pow(Math.sin(a / 2.0D), 2.0D) + Math.cos(radLat1)
				* Math.cos(radLat2) * Math.pow(Math.sin(b / 2.0D), 2.0D)));
